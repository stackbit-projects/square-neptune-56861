    ...
    return __awaiter(this, void 0, void 0, function () {
        function doDownloadSiteMap(suffix, apiUrl) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, common_2.fetchWithRetry(logger, apiUrl, 3, parseInt(common_1.getEnv(config.env, 'UNIFORM_PUBLISH_MAP_REQUEST_TIMEOUT', '90000')))];
                        case 1:
                            response = _a.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    _c.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, doDownloadSiteMap(suffix, common_1.getApiUrlWithToken(config, suffix))];
