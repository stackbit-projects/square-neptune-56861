...
var common_server_2 = require("@uniformdev/common-server");
function config(nextConfig) {
    nextConfig = nextConfig || {};
    if (!nextConfig.logger) {
        nextConfig.logger = common_server_1.serverLogger;
    }
    var runtime = common_2.getBoolEnv(process.env, 'UNIFORM_IS_AT_RUNTIME', false);
    var logger = nextConfig.logger;
    var ver = common_server_2.tryGetUniformVersion(logger);
    if (runtime && ver) {
    ...
    return Object.assign({}, nextConfig, {
        // Next 9 breaking change - default exportTrailingSlash value was changed from true to false
        ...
        exportPathMap: function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, common_server_1.exportPathMap(logger)];
